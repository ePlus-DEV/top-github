...
Contributions are accepted. Please report issues or make pull requests against either `master` or [branch for the website](https://github.com/ePlus-DEV/top-github/tree/gh-pages) as appropriate.
...
The [original project](https://github.com/lauripiispanen/most-active-github-users-counter) by [@lauripiispanen](https://github.com/lauripiispanen) seems to have been archived. I also thought that `top-github.eplus.dev` was a more appropriate domain name and quickly grabbed it :grinning:
